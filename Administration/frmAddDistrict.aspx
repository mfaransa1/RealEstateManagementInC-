<%@ Page Language="C#" MasterPageFile="~/Administration/AdminPropertyNetMasterPageMenu.master" Theme="PropertyNetThemes" AutoEventWireup="true" CodeFile="frmAddDistrict.aspx.cs" Inherits="Administration_frmAddDistrict" %>
...
<tr>
<td style="width:18%" >
District Name<span class="lblerror">*</span>
</td>
<td style="width:2%">:</td>
<td style="width:18%">
    <asp:TextBox ID="txtDistrictName" runat="server" Width="160px"></asp:TextBox>
    </td>
    <td>
    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtDistrictName"
        ErrorMessage="Please Enter DistrictName" >*</asp:RequiredFieldValidator>
    </td>
</tr>
...
<td>:</td>
<td>
    <asp:TextBox ID="txtDistrictDescription" runat="server" TextMode="MultiLine" Width="160px"></asp:TextBox>
    </td>
    <td>
    </td>
</tr>
...
<td colspan="2" style="height: 26px">
    ...
    <asp:Button ID="btnSubmit" runat="server" Text="Submit" class="btnstyle" OnClick="btnSubmit_Click" Width="65px" />&nbsp;
    <asp:Button ID="btnBack" runat="server" Text="Back" class="btnstyle" OnClick="btnBack_Click" CausesValidation="False" Width="65px" />
    </td>
</tr>
</table></td></tr></table>
</asp:Content>

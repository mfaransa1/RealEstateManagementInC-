<%@ Page Language="C#" MasterPageFile="~/Administration/AdminPropertyNetMasterPageMenu.master" Theme="PropertyNetThemes" AutoEventWireup="true" CodeFile="frmAddStatus.aspx.cs" Inherits="Administration_frmAddStatus" %>
...
<td colspan="2" style="height: 26px">
    ...
    <asp:Button ID="btnSubmit" runat="server" Text="Submit" class="btnstyle" OnClick="btnSubmit_Click" Width="65px" />
        <asp:Button ID="btnBack" runat="server" Text="Back" class="btnstyle" OnClick="btnAdd_Click" CausesValidation="False" Width="65px" /></td>
</tr>
</table>
</td></tr></table>
